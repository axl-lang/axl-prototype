...
@Data
public class ConditionElt extends SemanticNode implements Elt {

    private Value condition;

    private FrameElt then;

    private FrameElt also;
    ...
    public void codegen(MethodVisitor visitor, Stack<Label> labels) {
        ...
        visitor.visitJumpInsn(Opcodes.IFEQ, elseLabel);
